...
C_AUX		EQU	0x22					;VARIABLE PARA SALVAR EL CARRY
...
LOOP		
			...
			CALL		RETARDO			;PARA QUE ESTE MAS TIEMPO HABILITADO QUE DESHABILITADO EL TECLADO
...
TECLA		
	...
	;FILAS							;ESTABLECER DE QUE FILA VINO LA INTERRUPCION
			BTFSS		PORTB_AUX, 4
			MOVLW		0x01
